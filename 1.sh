...
CONFIG_TARGET_ROOTFS_PARTSIZE=27648
...
CONFIG_PACKAGE_kmod-sprd_pcie=y
# end of WWAN Support
...
# CONFIG_PACKAGE_php8-pecl-mcrypt is not set
# CONFIG_PACKAGE_php8-pecl-raphf is not set
# CONFIG_PACKAGE_php8-pecl-redis is not set
# CONFIG_PACKAGE_php8-pecl-sodium is not set
# CONFIG_PACKAGE_php8-pecl-swoole is not set
...
# CONFIG_PACKAGE_luci-i18n-ahcp-ca is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-cs is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-de is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-el is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-en is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-es is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-fr is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-he is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-hu is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-it is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-ja is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-ms is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-no is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-pl is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-pt is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-ro is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-ru is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-sk is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-sv is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-tr is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-uk is not set
# CONFIG_PACKAGE_luci-i18n-ahcp-vi is not set
CONFIG_PACKAGE_luci-i18n-ahcp-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-ahcp-zh-tw is not set
CONFIG_PACKAGE_luci-i18n-airplay2-zh-cn=y
CONFIG_PACKAGE_luci-i18n-aliyundrive-fuse-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-aliyundrive-fuse-zh_Hans is not set
...
# CONFIG_PACKAGE_luci-i18n-asterisk-ca is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-cs is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-de is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-el is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-en is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-es is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-fr is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-he is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-hu is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-it is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-ja is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-ms is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-no is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-pl is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-pt is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-ro is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-ru is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-sk is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-sv is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-tr is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-uk is not set
# CONFIG_PACKAGE_luci-i18n-asterisk-vi is not set
CONFIG_PACKAGE_luci-i18n-asterisk-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-asterisk-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-bcp38-ru is not set
# CONFIG_PACKAGE_luci-i18n-bcp38-sv is not set
CONFIG_PACKAGE_luci-i18n-bcp38-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-bcp38-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-clamav-ja is not set
# CONFIG_PACKAGE_luci-i18n-clamav-ru is not set
# CONFIG_PACKAGE_luci-i18n-clamav-sv is not set
...
# CONFIG_PACKAGE_luci-i18n-dawn-zh_Hans is not set
...
# CONFIG_PACKAGE_luci-i18n-design-config-zh_Hans is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-ca is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-cs is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-de is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-el is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-en is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-es is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-fr is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-he is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-hu is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-it is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-ja is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-ms is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-no is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-pl is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-pt is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-ro is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-ru is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-sk is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-sv is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-tr is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-uk is not set
# CONFIG_PACKAGE_luci-i18n-diag-core-vi is not set
CONFIG_PACKAGE_luci-i18n-diag-core-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-diag-core-zh-tw is not set
CONFIG_PACKAGE_luci-i18n-diskman-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-diskman-zh-tw is not set
# CONFIG_PACKAGE_luci-i18n-dnscrypt-proxy-ja is not set
# CONFIG_PACKAGE_luci-i18n-dnscrypt-proxy-ru is not set
CONFIG_PACKAGE_luci-i18n-dnsforwarder-zh-cn=y
CONFIG_PACKAGE_luci-i18n-docker-zh-cn=y
CONFIG_PACKAGE_luci-i18n-dockerman-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-dynapoint-de is not set
# CONFIG_PACKAGE_luci-i18n-dynapoint-ja is not set
# CONFIG_PACKAGE_luci-i18n-dynapoint-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-dynapoint-ru is not set
CONFIG_PACKAGE_luci-i18n-easymesh-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-easymesh-zh_Hans is not set
...
# CONFIG_PACKAGE_luci-i18n-fwknopd-en is not set
# CONFIG_PACKAGE_luci-i18n-fwknopd-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-fwknopd-ru is not set
CONFIG_PACKAGE_luci-i18n-gobinetmodem-zh-cn=y
...
# CONFIG_PACKAGE_luci-i18n-noddos-ja is not set
# CONFIG_PACKAGE_luci-i18n-noddos-ru is not set
...
# CONFIG_PACKAGE_luci-i18n-olsr-en is not set
...
# CONFIG_PACKAGE_luci-i18n-olsr-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-pagekitec-ja is not set
CONFIG_PACKAGE_luci-i18n-pcimodem-zh-cn=y
CONFIG_PACKAGE_luci-i18n-phtunnel-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-polipo-ca is not set
# CONFIG_PACKAGE_luci-i18n-polipo-cs is not set
# CONFIG_PACKAGE_luci-i18n-polipo-de is not set
# CONFIG_PACKAGE_luci-i18n-polipo-el is not set
# CONFIG_PACKAGE_luci-i18n-polipo-en is not set
# CONFIG_PACKAGE_luci-i18n-polipo-es is not set
# CONFIG_PACKAGE_luci-i18n-polipo-fr is not set
# CONFIG_PACKAGE_luci-i18n-polipo-he is not set
# CONFIG_PACKAGE_luci-i18n-polipo-hu is not set
# CONFIG_PACKAGE_luci-i18n-polipo-it is not set
# CONFIG_PACKAGE_luci-i18n-polipo-ja is not set
# CONFIG_PACKAGE_luci-i18n-polipo-ms is not set
# CONFIG_PACKAGE_luci-i18n-polipo-no is not set
# CONFIG_PACKAGE_luci-i18n-polipo-pl is not set
# CONFIG_PACKAGE_luci-i18n-polipo-pt is not set
# CONFIG_PACKAGE_luci-i18n-polipo-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-polipo-ro is not set
# CONFIG_PACKAGE_luci-i18n-polipo-ru is not set
# CONFIG_PACKAGE_luci-i18n-polipo-sk is not set
# CONFIG_PACKAGE_luci-i18n-polipo-sv is not set
# CONFIG_PACKAGE_luci-i18n-polipo-tr is not set
# CONFIG_PACKAGE_luci-i18n-polipo-uk is not set
# CONFIG_PACKAGE_luci-i18n-polipo-vi is not set
CONFIG_PACKAGE_luci-i18n-polipo-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-polipo-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-radicale-de is not set
# CONFIG_PACKAGE_luci-i18n-radicale-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-radicale-ru is not set
# CONFIG_PACKAGE_luci-i18n-radicale-sv is not set
...
# CONFIG_PACKAGE_luci-i18n-shairplay-ja is not set
# CONFIG_PACKAGE_luci-i18n-shairplay-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-shairplay-ru is not set
# CONFIG_PACKAGE_luci-i18n-simple-adblock-ja is not set
# CONFIG_PACKAGE_luci-i18n-simple-adblock-pt is not set
# CONFIG_PACKAGE_luci-i18n-simple-adblock-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-simple-adblock-ru is not set
# CONFIG_PACKAGE_luci-i18n-simple-adblock-sv is not set
CONFIG_PACKAGE_luci-i18n-socat-zh-cn=y
CONFIG_PACKAGE_luci-i18n-softethervpn-zh-cn=y
CONFIG_PACKAGE_luci-i18n-spdmodem-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-splash-ca is not set
# CONFIG_PACKAGE_luci-i18n-splash-cs is not set
# CONFIG_PACKAGE_luci-i18n-splash-de is not set
# CONFIG_PACKAGE_luci-i18n-splash-el is not set
# CONFIG_PACKAGE_luci-i18n-splash-en is not set
# CONFIG_PACKAGE_luci-i18n-splash-es is not set
# CONFIG_PACKAGE_luci-i18n-splash-fr is not set
# CONFIG_PACKAGE_luci-i18n-splash-he is not set
# CONFIG_PACKAGE_luci-i18n-splash-hu is not set
# CONFIG_PACKAGE_luci-i18n-splash-it is not set
# CONFIG_PACKAGE_luci-i18n-splash-ja is not set
# CONFIG_PACKAGE_luci-i18n-splash-ms is not set
# CONFIG_PACKAGE_luci-i18n-splash-no is not set
# CONFIG_PACKAGE_luci-i18n-splash-pl is not set
# CONFIG_PACKAGE_luci-i18n-splash-pt is not set
# CONFIG_PACKAGE_luci-i18n-splash-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-splash-ro is not set
# CONFIG_PACKAGE_luci-i18n-splash-ru is not set
# CONFIG_PACKAGE_luci-i18n-splash-sk is not set
# CONFIG_PACKAGE_luci-i18n-splash-sv is not set
# CONFIG_PACKAGE_luci-i18n-splash-tr is not set
# CONFIG_PACKAGE_luci-i18n-splash-uk is not set
# CONFIG_PACKAGE_luci-i18n-splash-vi is not set
CONFIG_PACKAGE_luci-i18n-splash-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-splash-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-tinyproxy-en is not set
...
# CONFIG_PACKAGE_luci-i18n-tinyproxy-zh-tw is not set
...
# Configuration
#
# CONFIG_FWKNOPD_GPG is not set
# CONFIG_FWKNOPD_NFQ_CAPTURE is not set
# end of Configuration
...
# CONFIG_PACKAGE_bmx6-json is not set
# CONFIG_PACKAGE_bmx6-sms is not set
# CONFIG_PACKAGE_bmx6-table is not set
# CONFIG_PACKAGE_bmx6-uci-config is not set
